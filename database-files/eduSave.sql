...
-- Student Data
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (1, 27, 'Herc', 'Vaun', 'hvaun0', 'hvaun0@nifty.com', 'Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.', 2011, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (2, 70, 'Reuben', 'Thunderman', 'rthunderman1', 'rthunderman1@deliciousdays.com', 'Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis.
...
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (3, 91, 'Willi', 'Jesteco', 'wjesteco2', 'wjesteco2@soup.io', 'Duis aliquam convallis nunc. Proin at turpis a pede posuere nonummy. Integer non velit.', 1986, true);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (4, 19, 'Dian', 'Strickett', 'dstrickett3', 'dstrickett3@tmall.com', 'Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.', 2000, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (5, 80, 'Roxine', 'Dorey', 'rdorey4', 'rdorey4@house.gov', 'Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.
...
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (6, 51, 'Gradeigh', 'Broggetti', 'gbroggetti5', 'gbroggetti5@discovery.com', 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus vestibulum sagittis sapien. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.

Etiam vel augue. Vestibulum rutrum rutrum neque. Aenean auctor gravida sem.', 2006, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (7, 81, 'Lyn', 'Bugg', 'lbugg6', 'lbugg6@phoca.cz', 'Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.', 2008, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (8, 80, 'Teddie', 'Musgrove', 'tmusgrove7', 'tmusgrove7@umich.edu', 'Duis bibendum, felis sed interdum venenatis, turpis enim blandit mi, in porttitor pede justo eu massa. Donec dapibus. Duis at velit eu est congue elementum.
...
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (10, 64, 'Oralee', 'Meatcher', 'omeatcher9', 'omeatcher9@wordpress.com', 'Donec diam neque, vestibulum eget, vulputate ut, ultrices vel, augue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi. Integer ac neque.

Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.

In sagittis dui vel nisl. Duis ac nibh. Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus.', 2004, true);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (11, 95, 'Ab', 'Paye', 'apayea', 'apayea@columbia.edu', 'Curabitur at ipsum ac tellus semper interdum. Mauris ullamcorper purus sit amet nulla. Quisque arcu libero, rutrum ac, lobortis vel, dapibus at, diam.', 1997, true);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (12, 50, 'Shannon', 'Kibel', 'skibelb', 'skibelb@buzzfeed.com', 'Phasellus sit amet erat. Nulla tempus. Vivamus in felis eu sapien cursus vestibulum.', 1996, true);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (13, 76, 'Bordie', 'Brommage', 'bbrommagec', 'bbrommagec@yahoo.co.jp', 'Aenean lectus. Pellentesque eget nunc. Donec quis orci eget orci vehicula condimentum.

Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo. Maecenas pulvinar lobortis est.

Phasellus sit amet erat. Nulla tempus. Vivamus in felis eu sapien cursus vestibulum.', 2011, true);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (14, 100, 'Cristian', 'Giovanitti', 'cgiovanittid', 'cgiovanittid@cbc.ca', 'Suspendisse potenti. In eleifend quam a odio. In hac habitasse platea dictumst.

Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.', 1988, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (15, 66, 'Fons', 'Stealfox', 'fstealfoxe', 'fstealfoxe@uol.com.br', 'Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis.', 2011, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (16, 34, 'Bernhard', 'Ashbolt', 'bashboltf', 'bashboltf@com.com', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.', 1993, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (17, 23, 'Dermot', 'Chiplin', 'dchipling', 'dchipling@tripadvisor.com', 'Aenean lectus. Pellentesque eget nunc. Donec quis orci eget orci vehicula condimentum.', 1996, true);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (18, 67, 'Carmon', 'Perot', 'cperoth', 'cperoth@hostgator.com', 'Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.

Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat.

Praesent blandit. Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede.', 1998, true);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (19, 86, 'Reider', 'Mateos', 'rmateosi', 'rmateosi@google.com', 'In hac habitasse platea dictumst. Morbi vestibulum, velit id pretium iaculis, diam erat fermentum justo, nec condimentum neque sapien placerat ante. Nulla justo.

Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis.

Sed ante. Vivamus tortor. Duis mattis egestas metus.', 1996, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (20, 30, 'Lorain', 'Spur', 'lspurj', 'lspurj@columbia.edu', 'Nullam sit amet turpis elementum ligula vehicula consequat. Morbi a ipsum. Integer a nibh.', 1999, true);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (21, 34, 'Monte', 'Gosker', 'mgoskerk', 'mgoskerk@kickstarter.com', 'Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.

Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat.', 2004, true);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (22, 13, 'Roderic', 'Tynemouth', 'rtynemouthl', 'rtynemouthl@wikipedia.org', 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem. Quisque ut erat.', 2003, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (23, 36, 'Ivan', 'Crowch', 'icrowchm', 'icrowchm@ucsd.edu', 'Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. Nullam orci pede, venenatis non, sodales sed, tincidunt eu, felis.', 1995, true);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (24, 83, 'Chrotoem', 'Piburn', 'cpiburnn', 'cpiburnn@parallels.com', 'Proin leo odio, porttitor id, consequat in, consequat ut, nulla. Sed accumsan felis. Ut at dolor quis odio consequat varius.', 2009, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (25, 36, 'Benedicto', 'Cusiter', 'bcusitero', 'bcusitero@examiner.com', 'Cras mi pede, malesuada in, imperdiet et, commodo vulputate, justo. In blandit ultrices enim. Lorem ipsum dolor sit amet, consectetuer adipiscing elit.', 1991, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (26, 58, 'Benyamin', 'Losebie', 'blosebiep', 'blosebiep@wordpress.com', 'Curabitur gravida nisi at nibh. In hac habitasse platea dictumst. Aliquam augue quam, sollicitudin vitae, consectetuer eget, rutrum at, lorem.

Integer tincidunt ante vel ipsum. Praesent blandit lacinia erat. Vestibulum sed magna at nunc commodo placerat.

Praesent blandit. Nam nulla. Integer pede justo, lacinia eget, tincidunt eget, tempus vel, pede.', 1992, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (27, 53, 'Chelsie', 'Beacock', 'cbeacockq', 'cbeacockq@netlog.com', 'Sed sagittis. Nam congue, risus semper porta volutpat, quam pede lobortis ligula, sit amet eleifend pede libero quis orci. Nullam molestie nibh in lectus.

Pellentesque at nulla. Suspendisse potenti. Cras in purus eu magna vulputate luctus.', 2005, true);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (28, 7, 'Georgie', 'Broadstock', 'gbroadstockr', 'gbroadstockr@csmonitor.com', 'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis.', 1993, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (29, 28, 'Ferd', 'De Giorgio', 'fdegiorgios', 'fdegiorgios@mapquest.com', 'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis.

Sed ante. Vivamus tortor. Duis mattis egestas metus.', 1996, true);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (30, 85, 'Linus', 'Legging', 'lleggingt', 'lleggingt@csmonitor.com', 'Donec diam neque, vestibulum eget, vulputate ut, ultrices vel, augue. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec pharetra, magna vestibulum aliquet ultrices, erat tortor sollicitudin mi, sit amet lobortis sapien sapien non mi. Integer ac neque.

Duis bibendum. Morbi non quam nec dui luctus rutrum. Nulla tellus.', 2007, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (31, 16, 'Karyn', 'Rizzo', 'krizzou', 'krizzou@abc.net.au', 'Fusce posuere felis sed lacus. Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem.
...
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (32, 43, 'Dolli', 'Huddleston', 'dhuddlestonv', 'dhuddlestonv@xrea.com', 'Vestibulum ac est lacinia nisi venenatis tristique. Fusce congue, diam id ornare imperdiet, sapien urna pretium nisl, ut volutpat sapien arcu sed augue. Aliquam erat volutpat.', 2009, false);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (33, 35, 'Juan', 'Corrado', 'jcorradow', 'jcorradow@omniture.com', 'Nam ultrices, libero non mattis pulvinar, nulla pede ullamcorper augue, a suscipit nulla elit ac nulla. Sed vel enim sit amet nunc viverra dapibus. Nulla suscipit ligula in lacus.
...
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (34, 88, 'Wally', 'MacKinnon', 'wmackinnonx', 'wmackinnonx@yellowbook.com', 'Aenean lectus. Pellentesque eget nunc. Donec quis orci eget orci vehicula condimentum.

Curabitur in libero ut massa volutpat convallis. Morbi odio odio, elementum eu, interdum eu, tincidunt in, leo. Maecenas pulvinar lobortis est.

Phasellus sit amet erat. Nulla tempus. Vivamus in felis eu sapien cursus vestibulum.', 1995, true);
insert into Student (Student_Id, Uni_Id, First_Name, Last_Name, Username, Student_Email, Student_Type, Grad_Year, Verified_Status) values (35, 3, 'Devan', 'Ashman', 'dashmany', 'dashmany@cbslocal.com', 'Praesent id massa id nisl venenatis lacinia. Aenean sit amet justo. Morbi ut odio.
...
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (21, 1, 'Free Delivery on Orders Over $15', 0, true, '1/3/2026', 'DELIVER0');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (22, 2, '10% Off School Supplies', 10, true, '1/6/2026', 'SUPPLY10');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (23, 3, '$8 Off Any Spa Treatment', 8, true, '1/9/2026', 'SPA8');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (24, 4, '20% Off Fitness Classes', 20, false, '1/12/2026', 'FIT20');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (25, 5, 'Buy 2 Get 1 Free on Accessories', 33, true, '1/18/2026', null);
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (26, 6, 'Free Car Wash with Oil Change', 0, true, '1/22/2026', 'WASH0');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (27, 7, '15% Off Acai Bowls', 15, true, '1/28/2026', 'ACAI15');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (28, 8, '$5 Off Escape Room Bookings', 5, true, '2/2/2026', 'ESCAPE5');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (29, 9, '20% Off Business Card Orders', 20, false, '2/6/2026', 'BIZ20');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (30, 10, 'Happy Hour 25% Off Drinks', 25, true, '2/11/2026', 'HAPPY25');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (31, 1, '$3 Off Any Sandwich', 3, true, '2/14/2026', 'SAND3');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (32, 2, 'Free Notebook with $25 Purchase', 0, true, '2/18/2026', 'NOTE0');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (33, 3, '30% Off Nail Services', 30, false, '2/22/2026', 'NAIL30');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (34, 4, 'First Month Gym Free', 100, true, '2/26/2026', 'GYMFREE');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (35, 5, '20% Off Winter Jackets', 20, false, '3/1/2026', 'JACKET20');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (36, 6, '$10 Off Brake Inspection', 10, true, '3/4/2026', 'BRAKE10');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (37, 7, 'Free Protein Add-On with Smoothie', 0, true, '3/7/2026', 'PROTEIN0');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (38, 8, '15% Off Mini Golf for Groups', 15, true, '3/11/2026', 'GOLF15');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (39, 9, '$20 Off Custom T-Shirt Orders', 20, true, '3/16/2026', 'SHIRT20');
insert into Discount (Biz_Id, Category_Id, Disc_Title, Disc_Amount, Disc_Status, Created_At, Promo_Code) values (40, 10, '10% Off Brunch Menu', 10, true, '3/22/2026', 'BRUNCH10');
...
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (21, 22, '1/5/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (22, 25, '1/10/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (23, 21, '1/13/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (24, 28, '1/17/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (25, 31, '1/21/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (26, 24, '1/25/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (27, 34, '1/29/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (28, 27, '2/3/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (29, 33, '2/6/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (30, 36, '2/10/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (31, 23, '2/13/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (32, 39, '2/17/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (33, 26, '2/21/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (34, 29, '2/24/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (35, 32, '2/28/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (36, 35, '3/3/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (37, 38, '3/8/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (38, 30, '3/13/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (39, 37, '3/19/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (40, 40, '3/25/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (1, 22, '1/6/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (5, 30, '1/20/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (9, 25, '2/4/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (13, 38, '2/16/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (17, 21, '2/23/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (22, 14, '3/2/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (28, 33, '3/7/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (34, 7, '3/14/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (38, 19, '3/22/2026');
insert into Saved_Discount (Student_Id, Discount_Id, Saved_At) values (40, 28, '3/30/2026');
...
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (3, 21, 22, '1/4/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (7, 22, 25, '1/9/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (11, 23, 28, '1/16/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (15, 24, 31, '1/21/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (19, 25, 34, '1/27/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (22, 26, 21, '2/3/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (24, 27, 27, '2/7/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (26, 28, 33, '2/12/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (28, 29, 36, '2/17/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (30, 30, 39, '2/22/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (21, 31, 23, '2/26/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (23, 32, 26, '3/2/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (25, 33, 29, '3/6/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (27, 34, 32, '3/10/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (29, 35, 35, '3/13/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (31, 36, 38, '3/17/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (33, 37, 24, '3/20/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (35, 38, 30, '3/24/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (37, 39, 37, '3/27/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (39, 40, 40, '3/31/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (3, 21, 22, '1/4/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (7, 22, 25, '1/9/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (11, 23, 28, '1/16/2026');
insert into Shared_Discount (Sender_Id, Receiver_Id, Discount_Id, Shared_At) values (15, 24, 31, '1/21/2026');
...
-- Report
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (1, 42, 56, 78, 'Full price charged', '11/29/2025', 53, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (2, 41, 5, 38, 'Full price charged', '1/9/2026', 38, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (3, 1, 95, 12, 'The discount did not apply', '10/24/2025', 57, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (4, 13, 39, 26, 'Full price charged', '1/26/2026', 45, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (5, 71, 60, 28, 'Incorrect pricing at checkout', '8/29/2025', 47, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (6, 87, 31, 11, 'Incorrect pricing at checkout', '9/14/2025', 26, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (7, 42, 93, 33, 'The discount did not apply', '10/19/2025', 44, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (8, 44, 79, 33, 'The discount did not apply', '1/7/2026', 1, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (9, 38, 11, 93, 'The discount did not apply', '12/13/2025', 2, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (10, 69, 64, 25, 'The discount did not apply', '4/24/2025', 51, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (11, 34, 71, 18, 'The discount did not apply', '5/20/2025', 7, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (12, 30, 51, 90, 'The discount did not apply', '12/20/2025', 25, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (13, 57, 95, 81, 'Incorrect pricing at checkout', '3/11/2026', 14, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (14, 22, 33, 23, 'The discount did not apply', '4/23/2025', 44, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (15, 48, 2, 38, 'Full price charged', '7/20/2025', 38, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (16, 1, 67, 27, 'The discount did not apply', '5/11/2025', 4, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (17, 10, 78, 58, 'Incorrect pricing at checkout', '9/8/2025', 33, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (18, 16, 75, 34, 'Incorrect pricing at checkout', '3/16/2026', 37, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (19, 64, 18, 7, 'Incorrect pricing at checkout', '9/18/2025', 20, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (20, 58, 47, 41, 'Full price charged', '5/28/2025', 47, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (21, 7, 67, 80, 'Full price charged', '2/27/2026', 53, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (22, 39, 19, 56, 'Full price charged', '8/24/2025', 54, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (23, 39, 84, 23, 'The discount did not apply', '1/22/2026', 32, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (24, 90, 69, 62, 'Incorrect pricing at checkout', '11/16/2025', 52, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (25, 81, 41, 48, 'Full price charged', '10/10/2025', 10, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (26, 96, 74, 13, 'Incorrect pricing at checkout', '2/20/2026', 45, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (27, 81, 63, 96, 'Incorrect pricing at checkout', '4/14/2025', 12, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (28, 54, 85, 53, 'Full price charged', '2/4/2026', 24, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (29, 66, 73, 58, 'Incorrect pricing at checkout', '4/3/2026', 59, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (30, 33, 26, 48, 'The discount did not apply', '7/25/2025', 4, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (31, 91, 38, 64, 'Full price charged', '10/25/2025', 40, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (32, 53, 22, 51, 'Full price charged', '12/26/2025', 11, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (33, 74, 39, 3, 'Incorrect pricing at checkout', '6/24/2025', 6, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (34, 21, 67, 77, 'Full price charged', '4/6/2026', 54, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (35, 10, 93, 8, 'Full price charged', '10/9/2025', 34, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (36, 79, 95, 66, 'Full price charged', '11/22/2025', 60, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (37, 78, 73, 38, 'Full price charged', '10/11/2025', 31, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (38, 10, 13, 6, 'Full price charged', '3/12/2026', 27, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (39, 78, 34, 85, 'Full price charged', '6/10/2025', 21, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (40, 76, 66, 29, 'The discount did not apply', '11/14/2025', 1, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (41, 34, 75, 51, 'Incorrect pricing at checkout', '8/1/2025', 35, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (42, 20, 23, 29, 'Full price charged', '10/30/2025', 35, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (43, 12, 86, 18, 'Full price charged', '8/31/2025', 15, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (44, 62, 43, 88, 'The discount did not apply', '7/18/2025', 26, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (45, 82, 55, 74, 'Incorrect pricing at checkout', '2/1/2026', 50, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (46, 34, 49, 3, 'Incorrect pricing at checkout', '10/28/2025', 6, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (47, 81, 79, 15, 'The discount did not apply', '10/21/2025', 46, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (48, 79, 44, 18, 'Full price charged', '9/9/2025', 43, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (49, 7, 4, 64, 'Incorrect pricing at checkout', '7/12/2025', 30, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (50, 57, 93, 73, 'The discount did not apply', '4/6/2026', 11, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (51, 29, 70, 39, 'Full price charged', '12/5/2025', 14, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (52, 52, 36, 49, 'Full price charged', '3/30/2026', 21, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (53, 67, 12, 15, 'The discount did not apply', '9/26/2025', 24, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (54, 93, 66, 21, 'The discount did not apply', '8/21/2025', 32, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (55, 96, 26, 24, 'The discount did not apply', '10/18/2025', 25, 'Discount removed successfully');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (56, 54, 21, 17, 'The discount did not apply', '4/20/2025', 42, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (57, 84, 81, 88, 'Full price charged', '8/17/2025', 22, 'Promotion not applicable');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (58, 14, 99, 64, 'Full price charged', '8/11/2025', 32, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (59, 5, 27, 62, 'Incorrect pricing at checkout', '11/8/2025', 6, 'Invalid promotion code');
insert into Report (Report_Id, Student_Id, Discount_Id, Admin_Id, Report_Msg, Submitted_At, Priority, Resolution) values (60, 44, 86, 63, 'Incorrect pricing at checkout', '4/29/2025', 23, 'Promotion not applicable');


-- Notification
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (1, 42, 'Report Resolved', 'Buy One Get One Free', '8/25/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (2, 21, 'Report Resolved', '50% off', '10/22/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (3, 14, 'New Discount', '50% off', '11/9/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (4, 40, 'New Discount', 'Buy One Get One Free', '11/2/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (5, 77, 'Report Resolved', 'Buy One Get One Free', '3/28/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (6, 28, 'Report Resolved', '50% off', '6/24/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (7, 86, 'New Discount', '50% off', '1/10/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (8, 25, 'Report Resolved', '50% off', '5/13/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (9, 88, 'Report Resolved', 'Buy One Get One Free', '10/20/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (10, 80, 'New Discount', '50% off', '11/29/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (11, 81, 'New Discount', '50% off', '9/4/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (12, 53, 'Report Resolved', '50% off', '6/20/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (13, 60, 'New Discount', '50% off', '11/4/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (14, 85, 'Report Resolved', '50% off', '1/4/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (15, 3, 'Report Resolved', 'Buy One Get One Free', '3/23/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (16, 45, 'New Discount', 'Deal Alert', '1/2/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (17, 46, 'Report Resolved', '50% off', '2/23/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (18, 43, 'New Discount', 'Deal Alert', '1/1/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (19, 76, 'Report Resolved', 'Deal Alert', '5/20/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (20, 4, 'Report Resolved', 'Limited Time Offer', '12/22/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (21, 54, 'Report Resolved', 'Limited Time Offer', '12/30/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (22, 28, 'New Discount', 'Buy One Get One Free', '7/26/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (23, 31, 'New Discount', 'Buy One Get One Free', '3/31/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (24, 52, 'New Discount', 'Buy One Get One Free', '1/24/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (25, 87, 'New Discount', '50% off', '10/11/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (26, 77, 'Report Resolved', '50% off', '12/30/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (27, 73, 'Report Resolved', '50% off', '7/25/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (28, 64, 'Report Resolved', 'Limited Time Offer', '9/30/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (29, 64, 'Report Resolved', 'Buy One Get One Free', '8/11/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (30, 83, 'Report Resolved', 'Deal Alert', '5/21/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (31, 22, 'Report Resolved', 'Buy One Get One Free', '8/30/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (32, 81, 'New Discount', 'Buy One Get One Free', '3/22/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (33, 23, 'New Discount', '50% off', '1/26/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (34, 76, 'Report Resolved', 'Buy One Get One Free', '6/30/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (35, 36, 'Report Resolved', '50% off', '8/14/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (36, 82, 'Report Resolved', 'Deal Alert', '11/29/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (37, 8, 'New Discount', 'Buy One Get One Free', '12/26/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (38, 22, 'Report Resolved', 'Limited Time Offer', '6/4/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (39, 63, 'New Discount', 'Buy One Get One Free', '3/13/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (40, 86, 'New Discount', 'Limited Time Offer', '4/16/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (41, 100, 'New Discount', 'Buy One Get One Free', '7/8/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (42, 28, 'New Discount', 'Buy One Get One Free', '7/7/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (43, 4, 'New Discount', 'Deal Alert', '8/21/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (44, 66, 'Report Resolved', 'Deal Alert', '8/6/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (45, 41, 'New Discount', '50% off', '3/10/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (46, 24, 'New Discount', '50% off', '7/22/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (47, 64, 'New Discount', 'Buy One Get One Free', '4/10/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (48, 60, 'New Discount', 'Buy One Get One Free', '8/11/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (49, 39, 'Report Resolved', '50% off', '4/10/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (50, 49, 'New Discount', 'Buy One Get One Free', '7/27/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (51, 97, 'New Discount', '50% off', '1/22/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (52, 87, 'Report Resolved', 'Deal Alert', '11/12/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (53, 52, 'New Discount', 'Limited Time Offer', '10/30/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (54, 65, 'New Discount', 'Buy One Get One Free', '7/18/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (55, 28, 'New Discount', 'Buy One Get One Free', '11/21/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (56, 86, 'Report Resolved', 'Deal Alert', '8/2/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (57, 79, 'Report Resolved', 'Limited Time Offer', '8/20/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (58, 60, 'Report Resolved', 'Deal Alert', '1/10/2026');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (59, 37, 'Report Resolved', 'Limited Time Offer', '6/4/2025');
insert into Notification (Notif_Id, Student_Id, Notif_Type, Notif_Msg, Sent_Date) values (60, 9, 'Report Resolved', 'Buy One Get One Free', '11/2/2025');


-- Listing_Analytics
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (1, 12, 91, 59, 45);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (2, 95, 50, 55, 20);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (3, 94, 21, 42, 97);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (4, 90, 85, 59, 58);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (5, 41, 66, 89, 70);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (6, 69, 64, 44, 4);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (7, 82, 16, 1, 24);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (8, 76, 32, 19, 39);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (9, 88, 74, 30, 89);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (10, 100, 79, 48, 16);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (11, 54, 23, 83, 58);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (12, 77, 83, 95, 20);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (13, 100, 34, 24, 59);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (14, 51, 70, 51, 7);
...
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (18, 69, 33, 41, 76);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (19, 38, 52, 40, 6);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (20, 60, 17, 47, 42);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (21, 42, 97, 67, 70);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (22, 99, 79, 41, 8);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (23, 77, 60, 95, 18);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (24, 22, 57, 83, 63);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (25, 43, 23, 74, 70);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (26, 23, 61, 22, 94);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (27, 53, 12, 34, 61);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (28, 36, 46, 47, 94);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (29, 49, 51, 98, 44);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (30, 86, 44, 26, 86);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (31, 32, 96, 34, 29);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (32, 63, 79, 43, 67);
...
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (36, 91, 22, 34, 41);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (37, 38, 58, 47, 72);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (38, 41, 67, 26, 48);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (39, 47, 28, 79, 29);
insert into Listing_Analytics (Analytics_Id, Disc_Id, View_Count, Save_Count, Redemption_Count) values (40, 38, 37, 96, 36);

-- Traffic_Snapshot Data
insert into Traffic_Snapshot (Snapshot_Id, Biz_Id, Period_Start, Period_End, Period_Label, Traffic_Count) values (1, 1, '2025-09-01 00:00:00', '2025-09-07 23:59:59', 'Week 1 September', 142);
insert into Traffic_Snapshot (Snapshot_Id, Biz_Id, Period_Start, Period_End, Period_Label, Traffic_Count) values (2, 1, '2025-09-08 00:00:00', '2025-09-14 23:59:59', 'Week 2 September', 198);
...
insert into Competitor_Listing (Competitor_Id, Biz_Id, Biz_Name, Disc_Amount, Redemption_Count, View_Count) values (1, 1, 'Dominos NEU', 15, 30, 200);
insert into Competitor_Listing (Competitor_Id, Biz_Id, Biz_Name, Disc_Amount, Redemption_Count, View_Count) values (2, 1, 'Papa Ginos Boston', 20, 18, 145);
...
insert into Platform_Metrics (Metrics_Id, Biz_Id, Total_Users, Active_Discs, Pending_Rpts, Snapshot_Date) values (1, 1, 850, 32, 5, '2025-09-15 00:00:00');
insert into Platform_Metrics (Metrics_Id, Biz_Id, Total_Users, Active_Discs, Pending_Rpts, Snapshot_Date) values (2, 1, 920, 35, 3, '2025-10-15 00:00:00');
